...
#python entryexit.py --prototxt mobilenet_ssd/MobileNetSSD_deploy.prototxt 	--model mobilenet_ssd/MobileNetSSD_deploy.caffemodel --input videos/example_01.mp4 	--output output/output_01.avi
#
...
def fn1():
    ...
    print("up===",up,"down===",down,"today_date",today_date,"today_time",today_time)
    ...
    cursor1.execute(
        "INSERT INTO visitor_table(up,down,visitor_date,visitor_time) VALUES ('" + up + "','" + down + "','" + today_date + "','" + today_time + "')")
    ...
    response = jsonify({"up":up,"down":down})
