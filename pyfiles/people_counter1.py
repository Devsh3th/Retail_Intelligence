...
def fn1():
    ...
    crowdCount = str(result[1][1])

    queueCount=str(result[3][1])

    print(crowdCount)

    print(queueCount)

    print(type(crowdCount))
    ...
    msg.attach(MIMEText("Over Crowded persons for queue are " + crowdCount, 'plain'))
    ...
    response = jsonify({'crowdCount': crowdCount,'averagePersonsInQueue':queueCount})
